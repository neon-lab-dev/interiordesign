    ...
    <section className="">
      <div className="login-container d-flex  items-center justify-between login-section w-100">
        ...
        <form action="" className="login-form">
          ...
          <div className="d-flex w-100 align-items-center justify-content-end text-danger" style={{ marginTop: '-14px' }}>
            Forgot Password?
          </div>
          <button type="submit" className="btn btn-base-transparent">Login</button>
          <div className="d-flex justify-content-center ">
            <span className="danger-text-neighbor" style={{ marginRight: '2px' }}>Don&apos;t have an account?</span>
